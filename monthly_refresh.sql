...
-- =========================================================================
-- STEP 1A: ENROLLED POPULATION
-- OFFERING_STATUS and LEVEL_NAME must both be ENROLLED.
-- FEP members excluded via ELIGMEMBER.
-- =========================================================================
...
SELECT DISTINCT C.GUID, E.CURRENTGUID
FROM CALLS_ONE_PER_DAY C
JOIN ENT_WH.ELIGMEMBER E ON C.GUID = E.GUID;
...
SELECT
    C.ACCOUNT, C.GUID, GS.CURRENTGUID, C.CUSTOMERID, C.CALL_DATE, C.CALL_TYPE,
...
FROM CALLS_ONE_PER_DAY C
LEFT JOIN GUID_STAGE GS ON C.GUID = GS.GUID
LEFT JOIN LM_TOPICS_DEDUPED LM ON C.ACCOUNT = LM.ACCOUNT AND C.CALL_DATE = LM.TOPIC_DATE
...
SELECT DISTINCT ACCOUNT, GUID, CURRENTGUID, 'Yes' AS TOBACCO_DISCUSSED
...
INSERT INTO Carefirst_Sandbox.COACHING_CALL_TOPICS
    (REPORT_MONTH, ACCOUNT, GUID, CURRENTGUID, CUSTOMERID, CALL_DATE, CALL_TYPE, RAW_TOPIC, REPORT_TOPIC, TOPIC_SOURCE, PROGRAM_TYPE, REFRESH_DATE)
SELECT
    TO_CHAR(SYSDATE, 'YYYYMM'), ACCOUNT, GUID, CURRENTGUID, CUSTOMERID, CALL_DATE, CALL_TYPE, RAW_TOPIC, REPORT_TOPIC, TOPIC_SOURCE, PROGRAM_TYPE, SYSDATE
FROM COACHING_TOPICS;
...
INSERT INTO Carefirst_Sandbox.COACHING_CALL_TOBACCO
    (REPORT_MONTH, ACCOUNT, GUID, CURRENTGUID, TOBACCO_DISCUSSED, REFRESH_DATE)
SELECT
    TO_CHAR(SYSDATE, 'YYYYMM'), ACCOUNT, GUID, CURRENTGUID, TOBACCO_DISCUSSED, SYSDATE
